...
class EsVersionReport(BaseReportABS):
    ...
    major_version = models.CharField(max_length=100, default="", verbose_name=_("主版本"))
    version_count = models.IntegerField(default=0, verbose_name=_("版本数量"))
